...
abstract class CustomBlockParserFactory<P : FenceBlockParser> : AbstractBlockParserFactory() {

    abstract fun checkOpener(line: CharSequence, index: Int, indent: Int): P?
